...
export function PublicLeaderboardPage() {
  ...
  return (
    <PublicLayout championshipId={championshipId} subtitle={championship.data?.name} liveBadge>
      <Link
        to={`/evento/${championshipId}`}
        className="mb-6 block text-xs font-bold uppercase tracking-wider text-muted-foreground"
      >
